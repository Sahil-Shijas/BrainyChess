    ...
    for (let row = 8; row >= 1; row--) {
        for (let col = 0; col < 8; col++) {
            ...
            square.addEventListener("click", function () {
                ...
                // If clicking the same selected piece, unselect it
                ...
                if (!selectedPiece && square.innerText !== "") {
                    ...
                    if (isValidMove(selectedPiece, fromPos, toPos) && square.innerText === "") {
                        ...
                        if (correctMoves.includes(toPos)) {
                            ...
                            displayMessage("Wrong move, try again.", "red");
                            setTimeout(() => location.reload(), 1000); // Reset after 1 sec
                        }
                    } else {
                        displayMessage("Invalid move! Try again.", "red");
                        setTimeout(() => location.reload(), 1000); // Reset after invalid move
                    }
